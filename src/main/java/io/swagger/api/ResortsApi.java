...
public interface ResortsApi {
    ...
    ResponseEntity<Void> addSeason(@Parameter(in = ParameterIn.PATH, description = "ID of the resort of interest", required=true, schema=@Schema()) @PathVariable("resortID") Integer resortID
, @Parameter(in = ParameterIn.DEFAULT, description = "Specify new Season value", required=true, schema=@Schema()) @Valid @RequestBody ResortIDSeasonsBody body
    ...
    @RequestMapping(value = "/resorts/{resortID}/seasons/{seasonID}/day/{dayID}/skiers",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<ResortSkiers> getResortSkiersDay(@Parameter(in = ParameterIn.PATH, description = "ID of the resort of interest", required=true, schema=@Schema()) @PathVariable("resortID") Integer resortID
